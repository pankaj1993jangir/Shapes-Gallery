package com.pj.jarassign.data.entity
...
data class ImageResponse(
    @SerializedName("current_user_collections") val currentUserCollections: List<Any?>? = null,
    @SerializedName("color") val color: String? = null,
    @SerializedName("sponsorship") val sponsorship: Sponsorship? = null,
    ...
    @SerializedName("categories") val categories: List<Any?>? = null,
...
data class Social(
    ...
    @SerializedName("paypal_email") val paypalEmail: Any? = null,
...
data class User(
    ...
    @SerializedName("twitter_username") val twitterUsername: Any? = null,
...
data class Sponsorship(
    @SerializedName("sponsor") val sponsor: Sponsor? = null,
    @SerializedName("tagline_url") val taglineUrl: String? = null,
    @SerializedName("tagline") val tagline: String? = null,
    @SerializedName("impression_urls") val impressionUrls: List<String?>? = null
)
